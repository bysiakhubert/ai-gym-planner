...
describe("formatNextCyclePrompt", () => {
  ...
  it("should format next cycle with session history", () => {
    const prompt = formatNextCyclePrompt(mockCurrentPlan, mockPreferences, mockSessionHistory, 4);
  ...
  it("should include current plan structure", () => {
    const prompt = formatNextCyclePrompt(mockCurrentPlan, mockPreferences, [], 4);
  ...
  it("should include user notes for next cycle", () => {
    const prompt = formatNextCyclePrompt(mockCurrentPlan, mockPreferences, [], 4, "Chcę zwiększyć ciężary");
  ...
  it("should handle null preferences", () => {
    const prompt = formatNextCyclePrompt(mockCurrentPlan, null, [], 4);
  ...
  it("should handle empty preferences object", () => {
    const prompt = formatNextCyclePrompt(mockCurrentPlan, {}, [], 4);
  ...
  it("should show skipped sets in history", () => {
    ...
    const prompt = formatNextCyclePrompt(mockCurrentPlan, mockPreferences, historyWithSkippedSet, 4);
